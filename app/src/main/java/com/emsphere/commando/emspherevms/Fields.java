...
/**
 * Created by seedcommando_6 on 2/3/2017.
 */

public class Fields implements Serializable {
    private String fname ,Lastname,image ,mobile ,EmailId ,visittype,Idcardtype ,Idcardnumber,Address ,Representing ,Remark,Visitpurpose ,persontomeet ,time ,duration ,Area ,material1  ,serialNo1,material2,serialNo2,VisitorRegistrationId ;
    Long VisitTypes;
